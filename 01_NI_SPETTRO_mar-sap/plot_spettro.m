...
hold on
plot(mSpec(:,1),mSpec(:,2),'r', S(:,1), S(:,2),'k-','Markersize',3,'MarkerFaceColor','auto','LineWidth',1);
xlabel('T [s]','FontSize',fontsize,'FontName',fontname);
ylabel('S_d [m]','FontSize',fontsize,'FontName',fontname);
xlim([0 S(end,1)])
box on
grid on
legend('Spettro Marker','Spettro SAP')
...
set(gca,'FontSize',fontsize,'FontName',fontname);
hold on
plot(mSpec(:,1),mSpec(:,3),'r', S(:,1), S(:,3),'k-','Markersize',3,'MarkerFaceColor','auto','LineWidth',1);
xlabel('T [s]','FontSize',fontsize,'FontName',fontname);
...
set(gca,'FontSize',fontsize,'FontName',fontname);
hold on
plot(mSpec(:,1),mSpec(:,4)/g,'r', S(:,1),S(:,4)/g,'k-','Markersize',3,'MarkerFaceColor','auto','LineWidth',1);
xlabel('T [s]','FontSize',fontsize,'FontName',fontname);
