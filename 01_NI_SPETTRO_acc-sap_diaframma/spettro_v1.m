...
dataIndex = 'C:\Users\Samuele\Desktop\01_NI_SPETTRO_acc-sap_diaframma\';      % folder with function
cd(dataIndex);
...
name_file(1,1) = {'Colonna NW - Marker M16 - 25%'};
name_file(2,1) = {'Colonna NW - Marker M42 - 25%'};
name_file(3,1) = {'Colonna NW - Marker M61 - 25%'};
name_file(4,1) = {'Colonna SE - Marker M26 - 25%'};
name_file(5,1) = {'Colonna SE - Marker M47 - 25%'};
name_file(6,1) = {'Colonna SE - Marker M66 - 25%'};
name_file(1,2) = {'Colonna NW - Marker M16 - 111%'};
name_file(2,2) = {'Colonna NW - Marker M42 - 111%'};
name_file(3,2) = {'Colonna NW - Marker M61 - 111%'};
name_file(4,2) = {'Colonna SE - Marker M26 - 111%'};
name_file(5,2) = {'Colonna SE - Marker M47 - 111%'};
name_file(6,2) = {'Colonna SE - Marker M66 - 111%'};
...
for colonna=1:2
    for riga=1:length(spettri_mar)
        ...
        % PLOT SPETTRO
        fun_spettro_v2(value_accSpectra,mar_spectra,0.039,4,1,110,name_file(riga,colonna)) ;
